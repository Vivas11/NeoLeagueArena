...
public class TorneoCompleto extends Torneo implements Serializable {
	private int cantidadFase;
	private int cantidadGrupo;
	private Equipo[][] grupos;

    public TorneoCompleto() {
        super();
    }

    public TorneoCompleto(String nombre, String juego) {
        super(nombre, juego);
    }

    public TorneoCompleto(String nombre, String juego, ArrayList<Equipo> equipos, ArrayList<Partida> partidas) {
        super(nombre, juego);
        setEquipos(equipos);
        setPartidas(partidas);
    }

    public TorneoCompleto(int cantidadFase, int cantidadGrupo, Equipo[][] grupos) {
		super();
